        ...
        <div className="grid gap-10 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <a href="https://github.com/unn-Known1/RepoRank" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm text-[var(--color-text-secondary)] transition-colors duration-200 hover:text-[var(--color-text)]">
                  GitHub
